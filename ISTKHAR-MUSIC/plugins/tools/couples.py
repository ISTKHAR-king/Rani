...
#BOT FILE NAME
from ISTKHAR-MUSIC import app as app
from ISTKHAR-MUSIC.mongo.couples_db import _get_image, get_couple

POLICE = [
    [
        InlineKeyboardButton(
            text="𝗦𝗨𝗣𝗣𝗢𝗥𝗧",
            url=f"https://t.me/THUNDERDEVS",
        ),
    ],
]
    ...
    try:
     ...
     #  if not is_selected:
         ...
         try:
            ...
            p1 = "ISTKHAR-MUSIC/assets/upic.png"
         try:
            p2 = await app.download_media(photo2.big_file_id, file_name="pfp1.png")
         except Exception:
            p2 = "ISTKHAR-MUSIC/assets/upic.png"
            
         img1 = Image.open(f"{p1}")
         img2 = Image.open(f"{p2}")

         img = Image.open("ISTKHAR-MUSIC/assets/cppic.png")
