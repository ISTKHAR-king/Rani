...
from ISTKHAR-MUSIC.plugins.tools.pretenderdb import (
    impo_off, impo_on, check_pretender,
    add_userdata, get_userdata, usr_data
)
from ISTKHAR-MUSIC.utils.admin_filters import admin_filter
...
""".format(
    ...
    if msg != "":
        await message.reply_photo(random. choice(THUNDER_IMG), caption=msg)
