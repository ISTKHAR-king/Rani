...
from ISTKHAR-MUSIC import YouTube, app
from ISTKHAR-MUSIC.core.call import ISTKHAR
from ISTKHAR-MUSIC.misc import SUDOERS, db
from ISTKHAR-MUSIC.utils.database import (
    get_active_chats,
    get_lang,
    get_upvote_count,
    is_active_chat,
...
from ISTKHAR-MUSIC.utils.database import get_assistant
from ISTKHAR-MUSIC.utils.decorators.language import languageCB
from ISTKHAR-MUSIC.utils.formatters import seconds_to_min
from ISTKHAR-MUSIC.utils.inline import close_markup, stream_markup, stream_markup_timer
from ISTKHAR-MUSIC.utils.stream.autoclear import auto_clean
from ISTKHAR-MUSIC.utils.thumbnails import get_thumb
from config import (
    BANNED_USERS,
    SOUNCLOUD_IMG_URL,
    STREAM_IMG_URL,
